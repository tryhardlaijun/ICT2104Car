...
coordinate * exploreMap (coordinate* map, int sensedData, coordinate * currentCoordinate , coordinate * previousCoordinate){
...
coordinate * getMap(){
    ...
    for(int i =0; i < totalLines; i++){
       ...
       map = exploreMap(map,sensorArray[i],&currentCoordinate, &previousCoordinate);
    }
